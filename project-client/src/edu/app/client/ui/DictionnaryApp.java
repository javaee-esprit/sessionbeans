...
import edu.app.services.TranslatorServiceRemote;
...
public class DictionnaryApp extends JFrame{
	...
	private TranslatorServiceRemote getProxy() {
		...
		try {
			...
			remote = (TranslatorServiceRemote) ctx.lookup("ejb:/project-ejb/TranslatorService!edu.app.services.TranslatorServiceRemote");
		} catch (Exception e) {
		}
		return remote;
	}
