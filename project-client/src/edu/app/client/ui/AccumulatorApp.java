...
import edu.app.services.AccumulatorServiceRemote;
...
public class AccumulatorApp extends JFrame{
	 ...
	 private AccumulatorServiceRemote getProxy() {
		 try {
				...
				remote = (AccumulatorServiceRemote) ctx.lookup("ejb:/project-ejb/AccumulatorService!edu.app.services.AccumulatorServiceRemote?stateful");
